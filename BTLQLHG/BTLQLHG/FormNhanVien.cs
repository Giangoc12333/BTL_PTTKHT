...
namespace BTLQLHG
{
    public partial class FormNhanVien : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                command.CommandText = "Insert Into NHANVIEN " +
                    "values('" + TxtMNV.Text + "',N'" + TxtTenNV.Text + "','" + DateNS.Text + "',N'" + TxtDiachi.Text + "','" + TxtCMT.Text + "','" + TxtEmail.Text + "','" + TxtDT.Text + "','" + DateNVL.Text + "','" + CbChucVu.Text + "')";
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            {
                command = connection.CreateCommand();
                command.CommandText = "Update NHANVIEN Set TenNV=N'" + TxtTenNV.Text + "', NgaySinh='" + DateNS.Text + "',DiaChi=N'" + TxtDiachi.Text + "',IDCMND='" + TxtCMT.Text + "',Email = '" + TxtEmail.Text + "',SDT = '" + TxtDT.Text + "',NgayVaoLam='" + DateNVL.Text + "',MaCV = '" + CbChucVu.Text + "'where MaNV = '" + TxtMNV.Text + "'";
                command.ExecuteNonQuery();
                LoadData();
